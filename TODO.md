# _skills Library — Task List

Ongoing tasks for keeping the skill library organized, well-documented, and easy to build on.
...
Becomes relevant as the library grows.
...
*Update this list by telling Claude what changed — it will mark tasks complete and add new ones as needed.*
